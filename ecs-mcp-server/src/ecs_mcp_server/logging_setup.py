...
- If ECS_MCP_LOG_FILE is set, a rotating file handler is also attached.
...
def setup_logging(
    ...
    # Clear existing handlers (idempotency in tests)
    ...
    return logging.getLogger("ecs_mcp_server")
