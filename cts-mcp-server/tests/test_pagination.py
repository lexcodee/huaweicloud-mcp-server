...
from cts_mcp_server.models import SearchTracesInput
from cts_mcp_server.tools.search import make_search_tools
...
class TestSinglePage:
    ...
    def test_returns_next_marker(self):
        ...
        with patch("cts_mcp_server.tools.search.get_cts_client") as mock_get:
...
class TestAutoPaginate:
    ...
    def test_three_pages_merged(self):
        ...
        with patch("cts_mcp_server.tools.search.get_cts_client") as mock_get:
            mock_client = MagicMock()
            mock_client.list_traces.side_effect = [page1, page2, page3]
            mock_get.return_value = mock_client
    ...
    def test_max_results_caps_and_sets_truncated(self):
        ...
        with patch("cts_mcp_server.tools.search.get_cts_client") as mock_get:
            mock_client = MagicMock()
            mock_client.list_traces.side_effect = [page1, page2]
            mock_get.return_value = mock_client
