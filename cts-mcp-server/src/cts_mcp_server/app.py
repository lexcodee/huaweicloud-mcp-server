...
log = logging.getLogger("cts_mcp_server.app")

KEEPALIVE_INTERVAL_SECONDS = float(os.environ.get("CTS_MCP_SSE_KEEPALIVE", "15"))
...
# Module-level app for `uvicorn cts_mcp_server.app:app`.
app = build_app()
