...
from huaweicloud_mcp.services.cts.mask_utils import (
    MASK_PLACEHOLDER,
    _is_sensitive_key,
    mask_and_truncate,
    mask_sensitive,
...
class TestMaskSensitiveStructured:
    ...
    def test_nested(self):
        payload = {"body": {"password": "***", "name": "alice"}}
        result = mask_sensitive(payload)
        parsed = json.loads(result)
